...
gulp.task('image_sprite', function () {
  var folders = getFolders(_src + 'muoitm/common/images/_sprite/');
  folders.forEach(function(folder){
    var _source, _imgOutput, _scssOutput, _prefix, _mode;
    _scssOutput = _src + 'muoitm/common/css/_sprite/';
    _imgOutput  = _src + 'muoitm/common/images/sprite/';
    _prefix = folder;
    _source = _src + 'muoitm/common/images/_sprite/' + folder + '/*.png';
    console.log(_source);
    ...
    .pipe(spritesmith({
      ...
      imgPath  : '/muoitm/common/images/sprite/sprite_' + _prefix + '.png?rev=' + new Date().getTime(),
      cssFormat: 'scss',
      padding  : 20,
...
gulp.task('watch', function() {
  ...
  cache.caches = {};
  return runSequence('clear', 'copy_files', 'browserSync', 'image_sprite', ['html', 'js', 'sass', 'image'], function() {
    ...
    watch(_src + 'muoitm/common/images/_sprite/**/*.png', function() {
